						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Full Name</label> <input
									required pattern="[A-Za-z]+" type="text" class="form-control" name="fullname">
							</div>
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Age</label> <input
									required type="text"  pattern="[0-9]{1,2}" class="form-control" name="age">
							</div>
							...
							<div class="col-md-6">
								...
								<input minlength="13" maxlength="13" pattern="^\+91(?:[0-9] ?){6,14}[0-9]$" required type="text" class="form-control"
									name="phno">
							</div>


							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Appointment for</label> <input
